...
pub fn do_create_invoice_from_time(
    ...
    conn.execute(
        ...
        params![client_id, engagement_id, invoice_number, format!("Generated from time entries {} to {}", date_from, date_to)],
    )
    ...
    for row in rows {
        ...
        conn.execute(
            ...
            params![invoice_id, format!("{} ({} hours)", activity, hours), hours as i64, rate_cents, amount_cents],
        )
